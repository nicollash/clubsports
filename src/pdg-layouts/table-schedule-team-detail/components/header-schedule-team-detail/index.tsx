      ...
      <View style={styles.headerWrapper}>
        <>
          <Text style={styles.eventName}>
            Team Schedule Summary Report: {`${event.event_name}`}
          </Text>
          <Text style={styles.scheduleName}>
            Event Start Date: {moment(event.event_startdate).format("MMMM D, YYYY")}
          ...
          <View style={styles.mainHeaderWrapper}>
            ...
            <View style={styles.mainHeaderCountsWrapper}>
              <Text style={styles.mainHeaderCell}>Game Count:</Text>
